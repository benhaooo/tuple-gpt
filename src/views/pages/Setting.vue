    ...
    <div class="p-10">
        <el-tabs>
            <el-tab-pane label="用户">
                <el-form :model="userConfig" label-width="auto" label-position="left">
                    ...
                    <el-form-item label="聊天记录">
                        <el-button class="relative overflow-hidden"><input @change="chatStore.importChat($event)" class="absolute w-full h-full top-0 left-0 opacity-0" type="file"></input><i class="iconfont mr-1">&#xe641;</i>导入</el-button>
            ...
            <el-tab-pane label="服务端">
                <el-input placeholder="必须包含http(s)://">
                    <template #prepend>OpenAI接口地址</template>
                </el-input>
                <el-input placeholder="自定义Open API Key">
