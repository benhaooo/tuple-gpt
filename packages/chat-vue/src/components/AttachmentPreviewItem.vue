<template>
  <div
    class="flex items-center gap-2 rounded-lg border bg-muted/50 px-2.5 py-2 hover:bg-muted transition-colors max-w-[200px]"
  >
    <!-- Icon slot -->
    <slot name="icon" />
    ...
    <div class="min-w-0 flex-1">
      ...
      <div v-if="subtitle" class="text-[10px] text-muted-foreground">
        {{ subtitle }}
      </div>
    </div>
