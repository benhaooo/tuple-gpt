...
import Message from "@shared/ui/components/Message.vue";
import SessionList from "@shared/ui/components/SessionList.vue";
import useAutoScrollToBottom from "@shared/hooks/scroll";
