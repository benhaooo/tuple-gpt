import { defineConfig, presetAttributify, presetWind, presetTypography, transformerDirectives, transformerVariantGroup } from 'unocss'
...
export default defineConfig({
  ...
  shortcuts: {
    // 动画快捷方式
    'animate-fade-in': 'animate-[fadeIn_0.2s_ease-in-out]',
    'animate-slide-up': 'animate-[slideUp_0.3s_ease-out]',
    'animate-scale-in': 'animate-[scaleIn_0.2s_ease-out]',
  },
  safelist: [],
  content: {
    pipeline: {
