/**
 * Integration tests — real Anthropic-compatible API calls.
 *
 * Requires .env.test.local:
 *   ANTHROPIC_API_KEY, ANTHROPIC_MODEL, ANTHROPIC_BASE_URL (optional)
 *
...
describeIf('Anthropic Integration', { timeout: 60_000 }, () => {
